...
export default function App() {
  return (
    <div className="min-h-screen bg-black text-gray-100 font-sans selection:bg-white/30 relative overflow-hidden flex items-center justify-center p-4 sm:p-8">
